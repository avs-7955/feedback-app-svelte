...
var app = (function () {
    ...
    /* src\components\RatingSelect.svelte generated by Svelte v3.59.1 */
    const file$7 = "src\\components\\RatingSelect.svelte";
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "class", "svelte-19obu1f");
    			add_location(input0, file$7, 13, 2, 274);
    			attr_dev(label0, "for", "num1");
    			attr_dev(label0, "class", "svelte-19obu1f");
    			add_location(label0, file$7, 21, 2, 407);
    			attr_dev(li0, "class", "svelte-19obu1f");
    			add_location(li0, file$7, 12, 1, 266);
    			attr_dev(input1, "type", "radio");
    			attr_dev(input1, "id", "num2");
    			attr_dev(input1, "name", "rating");
    			input1.value = "2";
    			input1.checked = input1_checked_value = /*selected*/ ctx[0] === 2;
    			attr_dev(input1, "class", "svelte-19obu1f");
    			add_location(input1, file$7, 24, 2, 453);
    			attr_dev(label1, "for", "num2");
    			attr_dev(label1, "class", "svelte-19obu1f");
    			add_location(label1, file$7, 32, 2, 586);
    			attr_dev(li1, "class", "svelte-19obu1f");
    			add_location(li1, file$7, 23, 1, 445);
    			attr_dev(input2, "type", "radio");
    			attr_dev(input2, "id", "num3");
    			attr_dev(input2, "name", "rating");
    			input2.value = "3";
    			input2.checked = input2_checked_value = /*selected*/ ctx[0] === 3;
    			attr_dev(input2, "class", "svelte-19obu1f");
    			add_location(input2, file$7, 35, 2, 632);
    			attr_dev(label2, "for", "num3");
    			attr_dev(label2, "class", "svelte-19obu1f");
    			add_location(label2, file$7, 43, 2, 765);
    			attr_dev(li2, "class", "svelte-19obu1f");
    			add_location(li2, file$7, 34, 1, 624);
    			attr_dev(input3, "type", "radio");
    			attr_dev(input3, "id", "num4");
    			attr_dev(input3, "name", "rating");
    			input3.value = "4";
    			input3.checked = input3_checked_value = /*selected*/ ctx[0] === 4;
    			attr_dev(input3, "class", "svelte-19obu1f");
    			add_location(input3, file$7, 46, 2, 811);
    			attr_dev(label3, "for", "num4");
    			attr_dev(label3, "class", "svelte-19obu1f");
    			add_location(label3, file$7, 54, 2, 944);
    			attr_dev(li3, "class", "svelte-19obu1f");
    			add_location(li3, file$7, 45, 1, 803);
    			attr_dev(input4, "type", "radio");
    			attr_dev(input4, "id", "num5");
    			attr_dev(input4, "name", "rating");
    			input4.value = "5";
    			input4.checked = input4_checked_value = /*selected*/ ctx[0] === 5;
    			attr_dev(input4, "class", "svelte-19obu1f");
    			add_location(input4, file$7, 57, 2, 990);
    			attr_dev(label4, "for", "num5");
    			attr_dev(label4, "class", "svelte-19obu1f");
    			add_location(label4, file$7, 65, 2, 1123);
    			attr_dev(li4, "class", "svelte-19obu1f");
    			add_location(li4, file$7, 56, 1, 982);
    			attr_dev(input5, "type", "radio");
    			attr_dev(input5, "id", "num6");
    			attr_dev(input5, "name", "rating");
    			input5.value = "6";
    			input5.checked = input5_checked_value = /*selected*/ ctx[0] === 6;
    			attr_dev(input5, "class", "svelte-19obu1f");
    			add_location(input5, file$7, 68, 2, 1169);
    			attr_dev(label5, "for", "num6");
    			attr_dev(label5, "class", "svelte-19obu1f");
    			add_location(label5, file$7, 76, 2, 1302);
    			attr_dev(li5, "class", "svelte-19obu1f");
    			add_location(li5, file$7, 67, 1, 1161);
    			attr_dev(input6, "type", "radio");
    			attr_dev(input6, "id", "num7");
    			attr_dev(input6, "name", "rating");
    			input6.value = "7";
    			input6.checked = input6_checked_value = /*selected*/ ctx[0] === 7;
    			attr_dev(input6, "class", "svelte-19obu1f");
    			add_location(input6, file$7, 79, 2, 1348);
    			attr_dev(label6, "for", "num7");
    			attr_dev(label6, "class", "svelte-19obu1f");
    			add_location(label6, file$7, 87, 2, 1481);
    			attr_dev(li6, "class", "svelte-19obu1f");
    			add_location(li6, file$7, 78, 1, 1340);
    			...
    			attr_dev(input7, "class", "svelte-19obu1f");
    			add_location(input7, file$7, 90, 2, 1527);
    			attr_dev(label7, "for", "num8");
    			attr_dev(label7, "class", "svelte-19obu1f");
    			add_location(label7, file$7, 98, 2, 1660);
    			attr_dev(li7, "class", "svelte-19obu1f");
    			add_location(li7, file$7, 89, 1, 1519);
    			...
    			attr_dev(input8, "class", "svelte-19obu1f");
    			add_location(input8, file$7, 101, 2, 1706);
    			attr_dev(label8, "for", "num9");
    			attr_dev(label8, "class", "svelte-19obu1f");
    			add_location(label8, file$7, 109, 2, 1839);
    			attr_dev(li8, "class", "svelte-19obu1f");
    			add_location(li8, file$7, 100, 1, 1698);
    			...
    			attr_dev(input9, "class", "svelte-19obu1f");
    			add_location(input9, file$7, 112, 2, 1885);
    			attr_dev(label9, "for", "num10");
    			attr_dev(label9, "class", "svelte-19obu1f");
    			add_location(label9, file$7, 120, 2, 2021);
    			attr_dev(li9, "class", "svelte-19obu1f");
    			add_location(li9, file$7, 111, 1, 1877);
    			attr_dev(ul, "class", "rating svelte-19obu1f");
    			add_location(ul, file$7, 11, 0, 244);
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "card svelte-1ffy299");
    			add_location(div, file$6, 2, 0, 43);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src\components\Button.svelte generated by Svelte v3.59.1 */
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", button_class_value = "" + (null_to_empty(/*style*/ ctx[0]) + " svelte-z3plyu"));
    			add_location(button, file$5, 6, 0, 113);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*style*/ 1 && button_class_value !== (button_class_value = "" + (null_to_empty(/*style*/ ctx[0]) + " svelte-z3plyu"))) {
    ...
    /* src\components\FeedbackForm.svelte generated by Svelte v3.59.1 */
    const file$4 = "src\\components\\FeedbackForm.svelte";

    // (63:3) <Button disabled={btnDisabled} type="submit">
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(63:3) <Button disabled={btnDisabled} type=\\\"submit\\\">",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "message svelte-1932uvn");
    			add_location(div, file$4, 66, 3, 1732);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-1932uvn");
    			add_location(h2, file$4, 50, 2, 1180);
    			attr_dev(header, "class", "svelte-1932uvn");
    			add_location(header, file$4, 49, 1, 1168);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "Tell us what you liked about us the most!");
    			attr_dev(input, "class", "svelte-1932uvn");
    			add_location(input, file$4, 55, 3, 1376);
    			attr_dev(div, "class", "input-group svelte-1932uvn");
    			add_location(div, file$4, 54, 2, 1346);
    			add_location(form, file$4, 52, 1, 1244);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const handleInput = () => {
    		if (text.trim().length <= min_length) {
    			$$invalidate(2, message = `Text must be at least ${min_length} characters`);
    	...
    	const handleSubmit = () => {
    		...
    		if (text.trim().length > min_length) {
    			const newFeedback = { id: v4(), text, rating: +rating }; // this makes rating into a number
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('min_length' in $$props) min_length = $$props.min_length;
    ...
    /* src\components\FeedbackItem.svelte generated by Svelte v3.59.1 */
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			t4 = text(t4_value);
    			attr_dev(div0, "class", "num-display svelte-1fq3p46");
    			add_location(div0, file$3, 13, 1, 261);
    			attr_dev(button, "class", "close svelte-1fq3p46");
    			add_location(button, file$3, 16, 1, 315);
    			attr_dev(div1, "class", "text-display");
    			add_location(div1, file$3, 17, 1, 389);
    		},
    		m: function mount(target, anchor) {
    ...
    /* src\components\FeedbackList.svelte generated by Svelte v3.59.1 */
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t = space();
    			add_location(div, file$2, 9, 1, 210);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    /* src\components\FeedbackStats.svelte generated by Svelte v3.59.1 */
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h4 = element("h4");
    			h4.textContent = "0 average";
    			add_location(h4, file$1, 10, 2, 182);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(" average");
    			add_location(h4, file$1, 8, 2, 142);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h4, anchor);
    			append_dev(h4, t0);
    ...
    function create_fragment$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*average*/ ctx[1] > 0) return create_if_block;
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			if_block.c();
    			add_location(h4, file$1, 6, 1, 94);
    			attr_dev(div, "class", "feedback-stats svelte-1wf8wm4");
    ...
    function create_fragment(ctx) {
    	...
    	feedbackform.$on("feedback-append", /*addFeedback*/ ctx[4]);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 39, 0, 994);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const addFeedback = e => {
    		...
    		$$invalidate(0, feedback = [newFeed, ...feedback]);
    	};
